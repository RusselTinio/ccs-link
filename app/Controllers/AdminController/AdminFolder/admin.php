...
class Admin extends BaseController
{
    ...
    public function check(){
        ...
        if(!$validation){
            return view('admin/loginform_admin', ['validation'=>$this->validator]);
        } else{
           ...
           $checkpassword = Hash::verify($password, $adminInfo['password']);
            if(!$checkpassword){
                ...
                return redirect()->to('AdminController/AdminFolder/Admin');
                ...
                if($role=='superadmin'){
                    return redirect()->to('adminController/SuperAdminFolder/PartnerController');
                } else return redirect()->to('adminController/AdminFolder/Admin/adminView');
