          ...
          <div class="row">
              <div class="col-xl-6 offset-xl-3">
                  <div class="text-box mt-5 mb-5">
                      ...
                      <form action="<?= base_url('Login/Auth/resetPassword') ?>" method="POST">
                          <?= csrf_field() ?>
                          ...
                          <div class="mb-4 form-floating">
                              ...
                              <input type="email" class="form-control" id="floatingInput" name="email"  placeholder="Enter a valid email address" value="<?= set_value('email')?>">
                              <span class="text-danger text-sm">
