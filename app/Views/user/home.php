...
<head>
    ...
    <link rel="icon" href="<?= base_url('assets/logo/ccs_logo.png') ?>" type="image/x-icon">
        ...
        <link rel="stylesheet" href="<?= base_url('style/footer/faq.css')?>">
        <link rel="stylesheet" href="<?= base_url('style/footer/term_cond.css')?>">
    </head>
                    ...
                    <div class="row height d-flex justify-content-center align-items-center">
                      <div class="col-md-6">
                        <div class="form">
                          ...
                          <form action="<?= base_url('Dash/Dash/searchUser')?>" method="post" onsubmit="return validateForm()">
                    ...
                    <div class="active-popular-post-carusel">	
                        <?php foreach($newsData as $data): ?>
                            <div class="single-popular-post d-flex flex-row">
                                <div class="thumb">
                                    <img src="<?= base_url('upload/news/').$data['news_image']?>" alt="" height="100" width="100">
                                    ...
                                    <div class="card swiper-slide ">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="icons">
                                                ...
                                                <li><i class="fa fa-phone"> <?= $data['contactNumber'] ?> </i></li>
