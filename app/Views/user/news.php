				...
				<div class="container" data-aos="fade-up">
				  ...
				  <div class="row">
					...
					<div class="col-lg-8 entries">
						...
						<div class="entry-img">
						  <img src="<?= base_url('upload/news/').$data['news_image'] ?>" alt="" class="img-fluid" style="margin:0 auto">
						</div>
					...
					<div class="col-lg-4">
					  ...
					  <div class="sidebar">
						...
						<h3 class="sidebar-title">Recent Posts</h3>
							...
							<div class="sidebar-item recent-posts">
								<?php foreach($newsRecent as $data):?>
							<div class="post-item clearfix">
								<img src="<?= base_url('upload/news/').$data['news_image'] ?>" alt="">
								<h4><?= $data['news_title']?></h4>
								<time datetime="2020-01-01"><?= $data['date_posted']?></time>
							</div>
								<?php endforeach;?>
